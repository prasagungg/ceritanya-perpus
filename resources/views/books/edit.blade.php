...
<div class="flex items-center content-center pb-6 justify-between">
    <h1 class="text-3xl text-black">Edit Buku</h1>
    <a href="{{ route('books.index') }}" class="bg-blue-500 text-white py-2 px-4 rounded">Kembali</a>
</div>

<div class="w-full">
    <div class="bg-white overflow-auto">
        <form action="{{ route('books.update', $book->id) }}" method="POST" class="p-5">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
              ...
              <input
                  ...
                  name="no_isbn"
                  id="no_isbn"
                  value="{{ old('no_isbn', $book->no_isbn) }}"
                  class="border rounded w-full py-2 px-3">
            </div>
            ...
            <div class="mb-4">
              ...
              <input
                  ...
                  name="no_catalog"
                  id="no_catalog"
                  value="{{ old('no_catalog', $book->no_catalog) }}"
                  class="border rounded w-full py-2 px-3">
            </div>
